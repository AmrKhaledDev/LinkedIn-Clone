...
function ButtonEditNotification({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={` absolute right-0 z-15 box flex-col gap-2 rounded-2xl sm:w-60 w-40 max-w-50 p-2 bg-white ${
      ...
      >
        <button
          ...
          className="w-full disabled:text-blue-300 disabled:border-blue-300 disabled:cursor-default disabled:hover:bg-transparent cursor-pointer flex items-center justify-center sm:px-4 px-3 sm:py-1.5 py-1 border-2 border-blue-600 text-blue-600 font-semibold rounded-full hover:bg-blue-50 hover:border-blue-700 transition-all duration-200 sm:text-[12px] text-[11px]"
        >
          Mark as read
        </button>
        ...
        <button
          ...
          disabled={loading}
          className="w-full disabled:text-gray-400 disabled:border-gray-400 disabled:cursor-default disabled:hover:bg-transparent cursor-pointer flex items-center justify-center sm:px-4 px-3 sm:py-1.5 py-1 border-2 border-gray-500 text-gray-500 font-semibold rounded-full hover:bg-gray-50 hover:border-gray-600 transition-all duration-200 sm:text-[12px] text-[11px]"
        >
          Delete Notification
        </button>
      </div>
