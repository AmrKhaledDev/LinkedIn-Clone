...
function ShowDisLikers({
  ...
  return (
    ...
    >
      <div className="rounded-xl shadow md:w-120 sm:w-120 w-[90%] bg-white h-fit flex flex-col">
        <div className="flex items-center justify-end border-b border-b-gray-100 p-1">
          <button
            ...
            >
              ...
              <div>
                ...
                <h3 className="font-normal sm:line-clamp-none line-clamp-3 text-gray-600 sm:text-[14px] text-[12px] wrap-break-word">
                  {dislike.user.headline && dislike.user.headline}
                </h3>
              </div>
            </div>
          ))}
