  ...
  return (
    <>
      <button
        ...
        className="border button border-gray-300 sm:text-[15px] text-[13px] rounded-full md:py-3 py-2 md:px-4 sm:px-3  px-2 w-full cursor-pointer text-start text-blackLight hover:bg-gray-100 transition-css"
      >
        Start a post
      </button>
